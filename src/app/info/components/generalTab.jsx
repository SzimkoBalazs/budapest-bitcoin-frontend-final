...
import OrderListComponent from "./charts/OrderListComponent";

import "primereact/resources/themes/lara-light-blue/theme.css";
import "primereact/resources/primereact.min.css";
import "primeicons/primeicons.css";
import CurrencyPieChart from "./charts/CurrencyPieChart";
import SalesTrendsChartSwitcher from "./SalesTrendsChartSwitcher";
...
const generalTab = ({
  ...
  return (
    <div className="p-4 bg-gray-100 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white shadow-md p-4 rounded-md min-w-[250px]">
          <div className="flex justify-between mb-3">
            <div>
              ...
              <div className="text-gray-900 font-semibold text-xl">
                {priceWithSpaceForAdmin(stats.totalPaidCount)}
              </div>
            </div>
          ...
          <span className="text-green-500 font-medium">
            {priceWithSpaceForAdmin(stats.newTodayCount)} new{" "}
          </span>
        ...
        <div className="bg-white shadow-md p-4 rounded-md">
          <div className="flex justify-between mb-3">
            <div>
              ...
              <div className="text-gray-900 font-semibold text-xl">
                {priceWithSpaceForAdmin(stats.stripeEurTotal / 100)}
              </div>
            </div>
          ...
          <span className="text-green-500 font-medium">
            {priceWithSpaceForAdmin(stats.stripeEurToday / 100)} EUR{" "}
          </span>
          <span className="text-gray-500">today</span>
        </div>
        ...
        <div className="bg-white shadow-md p-4 rounded-md">
          <div className="flex justify-between mb-3">
            <div>
              ...
              <div className="text-gray-900 font-semibold text-xl">
                {priceWithSpaceForAdmin(stats.stripeHufTotal / 100)}
              </div>
            </div>
          ...
          <span className="text-green-500 font-medium">
            {priceWithSpaceForAdmin(stats.stripeHufToday / 100)} HUF{" "}
          </span>
          <span className="text-gray-500">today</span>
        </div>
        ...
        <div className="bg-white shadow-md p-4 rounded-md">
          <div className="flex justify-between mb-3">
            <div>
              ...
              <div className="text-gray-900 font-semibold text-xl">
                {(stats.btcPaySatsTotal / 100000000).toFixed(8)}
              </div>
            </div>
          ...
          <span className="text-green-500 font-medium">
            {(stats.btcPaySatsToday / 100000000).toFixed(8)} BTC{" "}
          </span>
          <span className="text-gray-500">today</span>
        </div>
      </div>
      ...
      <div className="mt-6">
        <h3 className="text-gray-700 text-lg mb-4 lg:mb-0">Sales Comparison</h3>
        ...
        {selectedChart === "monthly" ? (
          <GeneralTabStackedMonthlyChart data={chartData} />
        ) : (
          <GeneralTabStackedMonthlyChart data={weeklyChartData} />
        )}
      </div>
      ...
      <div className="flex flex-col lg:flex-row justify-center gap-10 lg:gap-0 items-center lg:justify-between mt-10 lg:p-10">
        <div className="flex flex-col gap-4">
          <h3 className="text-center">Orders ditributed by currency</h3>
          <CurrencyPieChart currencyData={currencyData} />
        </div>
        <OrderListComponent ordersForGeneralTab={ordersForGeneralTab} />
      </div>
