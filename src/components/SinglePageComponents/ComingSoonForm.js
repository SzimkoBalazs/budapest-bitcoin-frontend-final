  ...
  return (
    <ContentWrapper className={'px-0 pr-2'} maxWidth={'max-w-[1440px]'}>
      <div
        ...
        style={{
          boxShadow:
            '1px 1px 0px #F7931A, 2px 2px 0px #F7931A, 3px 3px 0px #F7931A, 4px 4px 0px #F7931A, 5px 5px 0px #F7931A, 6px 6px 0px #F7931A, 7px 7px 0px #F7931A, 9px 9px 10px 3px rgba(247, 147, 26, 0.15)',
          borderRadius: 20,
