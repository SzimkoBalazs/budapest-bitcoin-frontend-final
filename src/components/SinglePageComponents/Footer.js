...
const Footer = () => {
  return (
    <div className="flex flex-col items-center gap-y-[56px] md:gap-y-[56px] w-full justify-center border-neutral-900 border-t-[4px] pt-[80px]" style={{background: `url('/bitcoin_background.svg')`, backgroundSize:'10%', backgroundColor:'black'}}>
