...
const FirstConference = ({ data }) => {
  return (
    <div className="flex flex-row flex-wrap items-start justify-center gap-[40px]">
      <div className="flex flex-1 xs:min-w-[320px] gap-4 max-w-[440px] flex-col items-start">
        ...
        <div className="flex flex-col items-start gap-[24px]">
          <div>
            ...
            <h3 className="text-primary-500 font-exo text-[28px] sm:text-[32px] font-extrabold leading-[110%] tracking-[4.8px]">
              {data.FirstCardTitle}
            </h3>
          </div>
      ...
      <div className="flex flex-1 pt-[6px] xs:min-w-[320px] gap-[24px] sm:gap-[40px] max-w-[440px] flex-col items-start">
