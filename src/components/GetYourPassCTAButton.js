...
const GetYourPassCTAButton = () => {
  return (
    <div className="group flex flex-col items-start gap-[10px]">
      <div className="flex justify-center items-center self-stretch pt-[0px] pr-[0.301px] pb-[7.624px] pl-[0px]">
        <div className="relative flex py-[10px] px-[16px] justify-end items-center gap-1 rounded-[40px] border-2 border-black bg-[linear-gradient(90deg,_white_53.99%,_#FFAE0B_54%)] hover:bg-[linear-gradient(90deg,_white_53.99%,_#F7931A_54%)] transition-all duration-200 shadow-[0px_6px_0px_0px_#000] active:bg-[#FFAE0B] active:bg-none active:shadow-none active:translate-y-[6px] group">
          {/* A szöveges kapszula */}
          <div className="flex justify-center items-center gap-[4px] p-[4px_6px] rounded-[40px] bg-white group-active:bg-transparent transition-all duration-200">
            <p className="text-[rgba(0,0,0,0.80)] font-exo text-center text-[14px] font-extrabold leading-normal group-active:text-white">
              GET YOUR PASS
            </p>
          </div>
          {/* Az SVG ikon */}
